...
<p><img src="//www.paygine.net/assets/mytemplate/img/logo.png" width="122" height="31" alt="Paygine" title="Платежная система Paygine" style="float:left; margin-right:0.5em; margin-bottom:0.5em; padding-top:0.25em;">
	Оплата по банковской карте осуществляется через платежную систему <b><a href="http://www.paygine.net">Paygine</a></b>, обеспечивающую простой и безопасный способ оплаты по карте.
<?php if ($this->fee >= 0.01) { ?>
